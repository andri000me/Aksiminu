...
<body style="background: url('uploads/images/forbg.jpg'); background-size: cover; font-family: Nunito;">
	...
	<div class="container" style="top: 50%; left: 50%; width: 100%; transform: translate(-50%, -50%); position: absolute;">
					...
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block" style="text-align: center;">
								<img src="<?= base_url('uploads/images/minuuu.png') ?>" width="85%">
							</div>
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form action="<?= base_url('auth/proses_login') ?>" method="POST" class="user">
										<div class="form-group">
											<input name="username" id="username" type="text" class="form-control form-control-user" placeholder="Masukkan Username..." required>
										</div>
										<div class="form-group">
											<input name="password" id="password" type="password" class="form-control form-control-user" placeholder="********" required>
										</div>
